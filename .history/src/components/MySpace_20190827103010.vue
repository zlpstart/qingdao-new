        ...
        <div class="MySpace" v-if="show">
            ...
            <div class="content">
                <div class="content_title">
                    <div class="xian"></div>
                    <h1><a :href="Footprint">点我跳转</a></h1>
                    <div class="xian"></div>
                </div>
                <div class="content_wrap">
                    <div class="content_box" @click="documents">
                        <div class="content_p">
                                <p>我的档案</p>
                        </div>
                    </div>
                    <div class="content_box" @click="license">
                        <div class="content_p">
                                <p>我的证照</p>
                        </div>
                    </div>
                    <div class="content_box" @click="Footprint">
                        <div class="content_p">
                                <p>我的足迹</p>
                        </div>
                    </div>
