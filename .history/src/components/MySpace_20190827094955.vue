<template>
    <div>
        <div class="MySpace" v-if="show">
            <TopBar></TopBar>
            <div class="header">
                <div class="header_wrap">
                    <div class="header_left" @click="menu">
                        <img :src="allUser.imgAddr" alt="">
                    </div>
            ...
            <div class="content">
                ...
                <div class="content_wrap">
                    <router-link tag="div" to="/Record" class="content_box">
                        <div class="content_p">
                                <p>我的档案</p>
                        </div>
                    </router-link>
                    <router-link tag="div" to="/license" class="content_box">
                        <div class="content_p">
                                <p>我的证照</p>
                        </div>
                    </router-link>
                    <router-link tag="div" :to="this.Footprint" class="content_box">
                        <div class="content_p">
                                <p>我的足迹</p>
                        </div>
                    </router-link>
        ...
        <button @click="sasa">点我出url</button>
        <a href="/Footprint">点我跳转</a>

        <div class="Enterprise" v-if="!show">
            <TopBar></TopBar>
                <div class="header">
                <div class="header_wrap">
...
export default {
    ...
    created(){
        this.getUsers()
         this.Footprint = window.location.href + "/Footprint"
    },
...
.content {
    width:8.4533rem;
    padding: 0.8533rem 0.4133rem 1.2rem 0.4133rem;
...
.content_box p {
    font-size:0.3467rem;
    font-weight:400;
    color:rgb(108, 114, 143);
    height: 0;
}
.content_p p {
    font-size:0.3467rem;
    font-weight:400;
    color:rgba(18,33,104,1);
    margin-top:0.28rem;
}
.btn {
    width: 2.24rem;
...
.btn button {
    ...
    border: 0.0133rem rgba(0,194,150,1) solid;
    font-size:0.3467rem;
    font-weight:500;
    color:rgba(255,255,255,1);
}
