    ...
    <div class="gengduo">
      <div class="gengduo-top">
        ...
        <div class="gengduo-top3">
          <div class="gengduo-img">
            <img src="../assets/保存.png" alt align="center"/>
          </div>
          <p>保存图片</p>
        </div>
      </div>
      <div class="gengduo_bottom"></div>
    </div>
  </div>
</template>
...
.footer_btn4 {
  ...
  box-shadow: 0px 0.0267rem 0.1333rem 0rem rgba(0, 194, 150, 0.53);
